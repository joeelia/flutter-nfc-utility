            ...
            children: [
              ListCellGroup(children: [
                ...
                ToggleSwitch(
                  ...
                  minHeight: 50.0,
                  fontSize: 16.0,
                  initialLabelIndex: _writeMode,
                  activeBgColor: Colors.green,
                  activeFgColor: Colors.white,
                  inactiveBgColor: Colors.grey,
                  inactiveFgColor: Colors.grey[900],
                  labels: ['Write', 'Write & Lock'],
                ...
                ListCellButton(
                  ...
                  onTap: !ss.hasData || ss.data.isEmpty ? null : () => startSession(
                    context: context,
                    handleTag: (tag) =>
                      Provider.of<NdefWriteModel>(context, listen: false).handleTag(tag, ss.data, _writeMode),
                  ),
                ),
              ]),
